...
bandwidths/, how does one compile or even design the program to actually
utilize the underlying hardware properly? This is the question we are
trying to answer in this paper. We provide an improved simulated
annealing approach to solve this problem. Our \textbf{key contributions}
in this paper are:
\begin{itemize}
...
is known NP-hard, the researchers take a heuristic approach. However,
yet again, the streaming community seems to not make a connection
between the polyhedral compiler optimization community and itself. In
...
that our SA approach out performs the standard SA technique by 84 \% on
average. We also compared our SA technique with the well established
K-way graph partitioning and heterogeneous bin packing heuristics. In
both these cases, our SA approach out performs the other two by a more
than 54\% on average.
