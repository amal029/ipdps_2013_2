...
\begin{figure*}[h!]
  \centering
  \subfigure[Binomial Option Pricing]{
    \includegraphics[angle=0, scale=0.6]{./figures/bin_random_surface}
    \label{fig:bin1random}
  }
  \subfigure[2 Dimensional Convolution]{
    \includegraphics[angle=0, scale=0.6]{./figures/conv_random_surface}
    \label{fig:conv1random}
  }
  \subfigure[Gram schmidtt linear-algebra kernel]{
    \includegraphics[angle=0, scale=0.6]{./figures/gram_random_surface}
    \label{fig:gram1random}
  }
  \subfigure[2 Dimensional Seidel stencil computation]{
    \includegraphics[angle=0, scale=0.6]{./figures/sei_random_surface}
    \label{fig:sei1random}
  }
  \subfigure[2 Dimensional Jacobi stencil computation]{
    \includegraphics[angle=0, scale=0.6]{./figures/jac_random_surface}
