...
\begin{figure*}[t!]
  ...
  \subfigure[Binomial Option Pricing]{
    \includegraphics[angle=0, scale=0.5]{./figures/bin_metis_surface}
    \label{fig:bin1metis}
  }
  \subfigure[2 Dimensional Convolution]{
    \includegraphics[angle=0, scale=0.5]{./figures/conv_metis_surface}
    \label{fig:conv1metis}
  }
  \subfigure[Gram schmidtt linear-algebra kernel]{
    \includegraphics[angle=0, scale=0.5]{./figures/gram_metis_surface}
    \label{fig:gram1metis}
  }
  \subfigure[2 Dimensional Seidel stencil computation]{
    \includegraphics[angle=0, scale=0.5]{./figures/sei_metis_surface}
    \label{fig:sei1metis}
  }
  \subfigure[2 Dimensional Jacobi stencil computation]{
    \includegraphics[angle=0, scale=0.5]{./figures/jac_metis_surface}
...
\begin{figure*}[t!]
  % \centering
  \subfigure[2 Dimensional Convolution]{
    \includegraphics[angle=0, scale=0.5]{./figures/conv_hbp_surface}
    \label{fig:conv1ho}
  }
  \subfigure[Gram schmidtt linear-algebra kernel]{
    \includegraphics[angle=0, scale=0.5]{./figures/gram_hbp_surface}
    \label{fig:gram1ho}
  }
  \subfigure[2 Dimensional Jacobi stencil computation]{
    \includegraphics[angle=0, scale=0.5]{./figures/jac_hbp_surface}
    \label{fig:jacl1ho}
  }
...
\begin{figure*}[h!]
  \centering
  \subfigure[Binomial Option Pricing]{
    \includegraphics[angle=0, scale=0.5]{./figures/bin_random_surface}
    \label{fig:bin1random}
  }
  \subfigure[2 Dimensional Convolution]{
    \includegraphics[angle=0, scale=0.5]{./figures/conv_random_surface}
    \label{fig:conv1random}
  }
  \subfigure[Gram schmidtt linear-algebra kernel]{
    \includegraphics[angle=0, scale=0.5]{./figures/gram_random_surface}
    \label{fig:gram1random}
  }
  \subfigure[2 Dimensional Seidel stencil computation]{
    \includegraphics[angle=0, scale=0.5]{./figures/sei_random_surface}
    \label{fig:sei1random}
  }
  \subfigure[2 Dimensional Jacobi stencil computation]{
    \includegraphics[angle=0, scale=0.5]{./figures/jac_random_surface}
