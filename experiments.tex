...
\begin{figure*}[t!]
  % \centering
  \subfigure[2 Dimensional Convolution]{
    \includegraphics[angle=0, scale=0.3]{./figures/conv_hbp_surface}
    \label{fig:conv1ho}
  }
  \subfigure[Gram schmidtt linear-algebra kernel]{
    \includegraphics[angle=0, scale=0.3]{./figures/gram_hbp_surface}
    \label{fig:gram1ho}
  }
  \subfigure[2 Dimensional Jacobi stencil computation]{
    \includegraphics[angle=0, scale=0.3]{./figures/jac_hbp_surface}
    \label{fig:jacl1ho}
  }
